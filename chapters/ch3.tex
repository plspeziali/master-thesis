...
We refer to this independence as an instance of a \textbf{blocked path}.
These blocked paths are illustrated in Figure \ref{fig:blocked_paths}.

\begin{figure}[h]
    \centering
    \includegraphics[width=.85\linewidth]{figures/ch3/18.blocked.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.85\linewidth]{figures/ch3/19.immorality.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.35\linewidth]{figures/ch3/20.descendant.png}
