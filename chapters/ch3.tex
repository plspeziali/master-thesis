...
\textbf{Interventional distributions} such as \( P(Y \mid \text{do}(T = t)) \)
...
\( P(Y) \), \( P(Y \mid \text{do}(T = t)) \), \( P(Y \mid \text{do}(T = t')) \), and
\( P(Y \mid \text{do}(T_2 = t_2)) \) are all completely different distributions that
...
\( P(y \mid \text{do}(T = t)) \) into a statistical estimand
...
\begin{equation}
P(y \mid \text{do}(T = t)) = \sum_{w} P(y \mid T = t, W = w) P(w)
\end{equation}
